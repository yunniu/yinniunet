	...
	<div class="container-fluid">
		...
		<div class="message text-center">
			...
			<div class="cart_content text-left">
				<form class="form-horizontal" action="/index.php/Home/order/address/agent_id/b154e7b21b2ff0a14d96affa6d3fb958" method="post">
			...
			<button class="btn green_btn" onclick="location.href='/index.php/Home/Order/pay/agent_id/<?php echo (session('agent_code')); ?>'">去支付</button>
		</div>
	</div>
</div>
<!--footer 开始-->
