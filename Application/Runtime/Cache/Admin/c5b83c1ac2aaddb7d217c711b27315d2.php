...
<?php if($goodsInfo[is_promote] != 1): ?><style>
                        ...
                        <div class="tab-pane active" id="tab_tongyong">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>商品货号</td>
                                    <td>                                                                               
                                        <input type="text" value="<?php echo ($goodsInfo["goods_sn"]); ?>" name="goods_sn" class="input-sm"/>
...
-->                                
                                ...
                                <tr>
                                    <td>本店售价:</td>
                                    <td>
                                        <input type="text" value="<?php echo ($goodsInfo["shop_price"]); ?>" name="shop_price" class="input-sm" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
                                ...
                                <tr>
                                    <td>市场价:</td>
                                    <td>
                                        <input type="text" value="<?php echo ($goodsInfo["market_price"]); ?>" name="market_price" class="input-sm" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
                                ...
                                <tr>
                                    <td>成本价:</td>
                                    <td>
                                        <input type="text" value="<?php echo ($goodsInfo["cost_price"]); ?>" name="cost_price" class="input-sm" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
                                ...
                                <tr>
                                    <td>商品重量:</td>
                                    <td>
                                        <input type="text" class="input-sm" value="<?php echo ($goodsInfo["weight"]); ?>" name="weight" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />&nbsp;克 (以克为单位)
                                ...
                                <tr>
                                    <td>库存数量:</td>
                                    <td>
                                        <?php if($goodsInfo[goods_id] > 0): ?><input type="text" value="<?php echo ($goodsInfo["store_count"]); ?>" class="input-sm" name="store_count" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />&nbsp;
                                        <?php else: ?>
                                            <input type="text" value="<?php echo ($tpshop_config[basic_default_storage]); ?>" class="input-sm" name="store_count" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />&nbsp;<?php endif; ?>
                                ...
                                <tr>
                                    <td>商品关键词:</td>
                                    <td>
                                        <input type="text" class="form-control" value="<?php echo ($goodsInfo["keywords"]); ?>" name="keywords"/>用空格分隔
