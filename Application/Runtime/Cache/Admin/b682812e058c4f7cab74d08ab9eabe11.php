						...
						<tbody>
						  <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr role="row" align="center">
		                     ...
		                     <td>
		                      ...
		                      <?php if($vo['role_id'] != 2): ?><a class="btn btn-danger" href="javascript:void(0)" data-url="<?php echo U('Admin/adminHandle');?>" data-id="<?php echo ($vo["admin_id"]); ?>" onclick="delfun(this)"><i class="fa fa-trash-o"></i></a><?php endif; ?>
							</td>
