...
//取消付款
function pay_callback(s,v){
	if(s==1){
        var v = v;
		layer.msg('操作成功', {icon: 1});
		layer.closeAll('iframe');
        location.href = "/index.php/Admin/order/detail/order_id/"+v;
	}else{
...
function selectGoods2(order_id){
	var url = "/index.php/Admin/Order/get_order_goods/order_id/"+order_id;
	layer.open({
		type: 2,
		title: '选择商品',
		shadeClose: true,
...
{
	var url = "/index.php/Admin/Order/add_return_goods/order_id/"+order_id+"/goods_id/"+goods_id;
	location.href = url;
}
</script>
</html>