                            ...
                            <table class="table table-bordered">
                                ...
                                <tr><td>所属代理：</td>
                                    <td>
                                        <div class="form-group">
                                            <div class="col-xs-1">
                                                <select name="proxys_id" id="proxys_id" class="form-control">
                                                    <?php if(is_array($proxys_list)): $i = 0; $__LIST__ = $proxys_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                            </div>
                                        </div>
                                    </td>
    ...
    function search_user()
	{
		...
		if($.trim(user_name) == '')
			return false;
			 ...
			 $.ajax({
                type : "POST",
                url:"/index.php/Agent/User/search_user",//+tab,
