                ...
                <div class="panel-body">
                    <div class="navbar navbar-default">
                            <form action="" id="search-form2" class="navbar-form form-inline" method="post" onsubmit="return false">
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="input-email">昵称</label>
                                    <div class="input-group">
                                        <input type="text" name="username" value="" placeholder="昵称" id="input-email" class="form-control">
                                        <!--<span class="input-group-addon" id="basic-addon2"><i class="fa fa-search"></i></span>-->
                                    </div>
                                </div>
                                <div class="form-group">
...
<script>
    $(document).ready(function(){
        ...
        //获取所有等级信息
        $.ajax({
            url:"/index.php/agent/user/getLevel",
            type:'post',
            dataType:'json',
    ...
    function ajax_get_table(tab,page){
        cur_page = page; //当前页面 保存为全局变量
            $.ajax({
                type : "POST",
                url:"/index.php/Agent/user/ajaxindex/p/"+page,//+tab,
