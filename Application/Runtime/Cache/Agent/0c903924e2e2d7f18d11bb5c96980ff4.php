      ...
      <div class="sidebar" style="overflow-y:scroll;">
        <ul class="nav nav-sidebar">
          ...
          <li style="margin-top:1em;margin-bottom:1em;">
            <a href="/index.php/Agent/index/index" style="padding:0;"><img src="/Public/images/header_logo.jpg" width="100%" height="46"></a>
          </li>
          ...
          <!--<li class="treeview">-->
            ...
            <!--<ul class="treeview-menu collapse" id="collapseExample">-->
              <!--<li>-->
                <!--<a href="/index.php/Agent/Admin/role" target='rightContent'>-->
                  <!--<i class="icon-circle-blank"></i>-->
                  <!--<span>角色管理</span>-->
                <!--</a>-->
              <!--</li>-->
              <!--<li>-->
                <!--<a href="/index.php/Agent/Admin/index" target='rightContent'>-->
                  <!--<i class="icon-circle-blank"></i>-->
                  <!--<span>管理员列表</span>-->
                <!--</a>-->
              <!--</li>-->
              <!--<li>-->
                <!--<a href="/index.php/Agent/Admin/log" target='rightContent'>-->
                  <!--<i class="icon-circle-blank"></i>-->
                  <!--<span>管理员日志</span>-->
                <!--</a>-->
              <!--</li>-->
...
<section class="content-wrapper right-side" id="riframe" style="margin:0px;padding:0px;">
    ...
    <div class="main">
        <div class="main_header">
            <div class="container">
                <div class="row">
                    <div class="col-sm-9 col-md-10 "><a href="/index.php/Agent/index/index" style="color:#000;font-weight: bold;font-size:2em;text-decoration:none;">代理系统后台</a></div>
                    <div class="col-sm-3 col-md-2">
                        ...
                        <div class="btn-group dropdown-menu-left  dropdown" >
                            <a href="#" type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" style="border:0">
                                <span style="color:#3c8dbc;"><span class="glyphicon glyphicon-user"></span><?php echo ($agent_info["username"]); ?><span class="caret"></span></span>
                            </a>
                            <ul class="dropdown-menu ">
                                <li><a href="/index.php/Agent/agent/logout">切换用户</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <!--页面主体-->
        <iframe id='rightContent' name='rightContent' src="/index.php/Agent/index/welcome" frameborder="0" width="100%" height="80%"  ></iframe>
        <!--</div>-->
    </div>
</section>
