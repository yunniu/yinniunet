  ...
  <body class="loginpage">
    <div class="loginbox">
      ...
      <div class="loginboxinner">
          <div class="logo">
              <h1 class="logo">代理.<span>商城</span></h1>
              <span class="slogan">代理后台管理系统</span>
          </div><!--logo-->
          ...
          <div class="form-group has-feedback">
          	<opinioncontrol realtime="true" opinion_name="vertify_code" default="true">
                <div class="row" style="padding-right: 65px;">
                    ...
                    <div class="col-xs-4">
                        <img id="imgVerify" style="cursor:pointer;" src="<?php echo U('Agent/vertify');?>" onclick="fleshVerify();"/>
                    </div>
                </div>
            </opinioncontrol>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              <div class="checkbox icheck">
          	 ...
          	 <button class="loginbtn" type="button" onclick="checkLogin()">立即登陆 </button>  
          
              <div class="keep"><input type="checkbox" name="remember" value="0" id="checkadmin"  /> 记住用户名</div>
          </form>
      </div>
    ...
    <script>
      ...
      function fleshVerify(){
          //重载验证码
          $('#imgVerify').attr('src','/index.php?m=Agent&c=Agent&a=vertify&r='+Math.floor(Math.random()*100));
      }
      ...
      function checkLogin(){
          ...
          $.ajax({
  			url:'/index.php?m=Agent&c=Agent&a=login&t='+Math.random(),
			type:'post',
			dataType:'json',
